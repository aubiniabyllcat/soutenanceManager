...
const postData: DataType[] = [
    {
        ...
        name: 'M ADJA Frimas',
        imgSrc: '/images/Expert/soutenant1.jpg',
        style:"15px",
        width:363,
        height:462,
    },
    {
        profession: 'Etudiante en Informatique de Gestion',
        name: 'Mlle MIGAN Eliane',
        imgSrc: '/images/Expert/soutenant2.jpg',
        style:"15px",
        width:800,
        height:462,
    },
    {
        ...
        imgSrc: '/images/Expert/soutenant3.jpg',
        style:"15px",
        width:331,
        height:262,
    },
                            ...
                            <div key={i}>
                                <div className='m-3 py-14 my-10 text-center'>
                                    <div className="relative" >
                                        <Image src={items.imgSrc} alt="" width={items.width} height={items.height} className="inline-block m-auto" />
                                        {/* <div className="absolute top-[50%] right-[2%]">
                                            <Image src={'/images/Expert/Linkedin.svg'} alt="linkedin" width={220} height={120} />
                                        </div> */}
                                    </div>
                                    <h3  className='text-2xl mt-3 font-semibold text-lightblack'>{items.name}</h3>
