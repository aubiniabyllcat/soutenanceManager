...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center py-5.5 lg:py-6.5 font-bold text-bodydark2">
        SM ADMIN
      </div>
        <button
          ref={trigger}
...
Enseignant                        <svg
              ...
              <li>
                <Link
                  href="/settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 mb-60 ${
  ...
  <Link
    href="#"
    className={`logout-link flex justify-end group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
      (pathname === "" || pathname.includes("auth")) && "bg-graydark dark:bg-meta-4"
    }`}
  >
    <svg
      className="fill-current"
