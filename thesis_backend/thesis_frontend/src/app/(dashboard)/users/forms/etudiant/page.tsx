...
<<<<<<< HEAD:thesis_backend/thesis_frontend/src/app/(dashboard)/users/forms/etudiant/page.tsx
...
const AddEtudiant = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert("Enrégistrement éffectué avec succès !!!");
...
>>>>>>> 95b2668561d1e6029986d9c9b87f1256faa18c3e:thesis_backend/thesis_frontend/src/app/(dashboard)/users/Etudiant/page.tsx
          </div>
