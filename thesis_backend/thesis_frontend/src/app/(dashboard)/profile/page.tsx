 ...
 <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-sm">
                <span className="font-bold">Date de naissance:</span> 13 Juillet 1983
              </div>
              <div className="text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Project Cards */}
            {[
              { title: 'Envato Website', color: 'bg-red-500', progress: 35 },
              { title: 'ThemeForest CMS', color: 'bg-teal-500', progress: 63 },
              { title: 'VectorLab Portfolio', color: 'bg-green-500', progress: 75 },
              { title: 'Adobe Muse Template', color: 'bg-purple-500', progress: 50 }
            ].map((project, index) => (
              <div key={index} className="bg-white shadow-md rounded-lg p-6">
                <div className="flex justify-between items-center mb-4">
                  <div className={`w-16 h-16 rounded-full ${project.color} flex items-center justify-center text-white font-bold`}>
                    {project.progress}%
                  </div>
                  <div>
                    <h3 className={`text-lg font-semibold ${project.color} text-white px-3 py-1 rounded`}>{project.title}</h3>
                    <p className="text-sm text-gray-600 mt-2">Début: 15 Juillet</p>
